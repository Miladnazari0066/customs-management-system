export const SUPABASE_SQL_SCHEMA = `-- SUPABASE SQL SCHEMA FOR CUSTOMS MANAGEMENT SYSTEM
-- Copy and run this script in Supabase SQL Editor (https://supabase.com/dashboard/project/_/sql)
